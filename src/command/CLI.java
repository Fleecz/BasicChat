...
public class CLI implements IChatObserver {
    ...
    public CLI() {
        ...
        cmds.put("/setname", new SetNameCommand((UserProfile) userProfile));
        cmds.put("/showname", new ShowNameCommand((UserProfile) userProfile));
        cmds.put("/clearname", new ClearNameCommand((UserProfile) userProfile));
    }
